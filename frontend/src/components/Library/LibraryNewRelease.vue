...
async function getNewRelease(){
    const url = new URL('http://127.0.0.1:8000/api/v1/books/new_release')
...
onMounted(async() =>{
    const fetchResult = await getNewRelease()
...
<template>
    <div id="library-new-release">
        <div id="button-scroll-new-release" class="child-new-release">
            <div id="button-container-new-release">
        ...
        <div id="book-container-new-release"class="child-new-release" ref="bookContainer">

            <router-link :to="'book-details-library/'+book.id" class="book-link" v-for="book in listBook">
                <div class="book-item-new-release">
                    <div class="book-image-new-release">
                        <img :src="'http://127.0.0.1:8000/'+book.cover"  alt="Book Cover">
                    </div>
                    <div class="book-detail-new-release">
...
<style scoped>
    ...
    #button-scroll-new-release {
        position: relative;
    }

    #button-container-new-release{
        /* border: 2px solid black; */
        height: 100%;
        width: fit-content;
        position: absolute;
    ...
    #book-container-new-release::-webkit-scrollbar {
        display: none;
    }
    ...
    .book-item-new-release:last-child{
        margin-right: 0px;
    }

    .book-image-new-release img {
        width: 100%;
        height: 100%;
        object-fit: cover; /* Memastikan gambar mengisi area container tanpa distorsi */
    }

    .book-detail-new-release{
        display: grid;
